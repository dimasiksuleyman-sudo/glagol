...
0.5.0: повторить RU/EN по [english-runtime](english-runtime.md), добавление только
второй модели, сохранение runtime при удалении, отдельные consent/30-дневные receipts.
Новые документы содержат speech_language, старые WAV/NULL остаются прежними.
Четыре EN и пять RU голосов проверяются отдельно; язык UI не меняет выбранный голос.
