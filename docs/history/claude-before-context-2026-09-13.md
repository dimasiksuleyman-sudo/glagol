...
Содержимое CLAUDE.md до внедрения системы контекста 2026-09-13.
Относительные ссылки ниже сохранены как в исходном файле из корня проекта.
Актуальный процесс: [AGENTS.md](../../AGENTS.md).
