...
//! Sprint 5 (planned): `audio_cache_root` becomes configurable via the Settings
//! page. When that change lands, this module is the only place that needs to
//! learn about the user-configured root — call sites stay unchanged.
